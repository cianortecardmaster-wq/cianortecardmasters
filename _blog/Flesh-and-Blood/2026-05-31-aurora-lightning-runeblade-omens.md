---
layout: post
title: "Aurora em Omens of the Third Age: o retorno da Lightning Runeblade"
category_label: "Flesh and Blood"
schema_type: "BlogPosting"
summary: "Análise da nova Aurora em Flesh and Blood: Lightning Runeblade, Lightning Flow, cartas de Omens, Silver Age, Classic Constructed, cartas baratas, upgrades competitivos e fraquezas."
...
image: "/assets/img/banners/banner-card-hero-aurora.webp"
...
<div class="tcg-card-grid">
  ...
  {% include tcg-card.html game="fab" name="Aurora, Shooting Star" %}
...
<div class="tcg-card-grid">
  {% include tcg-card.html game="fab" name="Electryn Joltstep" pitch="red" %}
  {% include tcg-card.html game="fab" name="Voltbound Duality" pitch="red" %}
  {% include tcg-card.html game="fab" name="Singeing Flowstride" pitch="red" %}
  {% include tcg-card.html game="fab" name="Mercurial Skies" pitch="red" %}
</div>
...
1. jogar um ataque Lightning;
2. dar ou manter go again;
3. usar Scorpio como extensão;
4. somar dano físico com ping arcano.
...
<div class="tcg-card-grid">
  ...
  {% include tcg-card.html game="fab" name="Path of Same Ends" pitch="red" %}
  {% include tcg-card.html game="fab" name="Electryn Mindmeld" pitch="red" %}
  {% include tcg-card.html game="fab" name="Scorpio, Comet Tail" %}
</div>
...
<div class="tcg-card-grid">
  ...
  {% include tcg-card.html game="fab" name="Blink" pitch="red" %}
  {% include tcg-card.html game="fab" name="Burn Up" pitch="red" %}
  {% include tcg-card.html game="fab" name="Arc Lightning" pitch="red" %}
  {% include tcg-card.html game="fab" name="Entwine Lightning" pitch="red" %}
  {% include tcg-card.html game="fab" name="Weave Lightning" pitch="red" %}
  {% include tcg-card.html game="fab" name="Arcanic Shockwave" pitch="red" %}
  {% include tcg-card.html game="fab" name="Snatch" pitch="red" %}
</div>
...
<div class="tcg-card-grid">
  {% include tcg-card.html game="fab" name="Sizzle" pitch="red" %}
  {% include tcg-card.html game="fab" name="Static Shock" pitch="red" %}
  {% include tcg-card.html game="fab" name="Photon Rush" pitch="red" %}
  {% include tcg-card.html game="fab" name="Lightning Surge" pitch="red" %}
  {% include tcg-card.html game="fab" name="Second Strike" pitch="red" %}
  {% include tcg-card.html game="fab" name="Fry" pitch="red" %}
</div>
...
<div class="tcg-card-grid">
  {% include tcg-card.html game="fab" name="Aether Ironweave" %}
  {% include tcg-card.html game="fab" name="Vexing Quillhand" %}
  {% include tcg-card.html game="fab" name="Grasp of the Arknight" %}
  {% include tcg-card.html game="fab" name="Lightning Greaves" %}
  {% include tcg-card.html game="fab" name="Shock Charmers" %}
  {% include tcg-card.html game="fab" name="Dyadic Carapace" %}
  {% include tcg-card.html game="fab" name="Fyendal's Spring Tunic" %}
