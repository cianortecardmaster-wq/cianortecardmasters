---
title: "Zyggy Starlight: análise do Lightning Illusionist no Classic Constructed"
category_label: "Flesh and Blood"
category: "flesh-and-blood"
content_style: "flesh-and-blood"
schema_type: "BlogPosting"
summary: "Análise profunda de Zyggy Starlight para Classic Constructed: como Illusionist funciona, diferenças para Prism, Dromai e Enigma, auras, holo counters, Fragment, cartas antigas e novas, gameplay e impacto no meta."
description: "Guia de Zyggy Starlight no Classic Constructed de Flesh and Blood: auras, holo counters, Fragment, Aphrodias, cartas antigas e meta em Cianorte."
keywords:
  - Zyggy Starlight
  - Zyggy Classic Constructed
  - Lightning Illusionist
  - Flesh and Blood Classic Constructed
  - Flesh and Blood Cianorte
  - Illusionist Flesh and Blood
...
<div class="tcg-card-grid" aria-label="Cartas centrais de Zyggy Starlight em Classic Constructed">
...
<div class="tcg-card-grid" aria-label="Ataques e cartas com Fragment para Zyggy">
  {% include tcg-card.html game="fab" name="Blink of an Eye" pitch="red" %}
  {% include tcg-card.html game="fab" name="Ebbing Arcstride" pitch="red" %}
  {% include tcg-card.html game="fab" name="Pulsing Cardia" pitch="red" %}
  {% include tcg-card.html game="fab" name="Shattering Flowtide" pitch="red" %}
</div>
...
1. Ataca com uma carta que ameaça dano físico.
2. O oponente bloqueia e ativa Fragment.
3. Zyggy ganha recurso, Lightning Flow, go again ou valor de aura.
4. Uma aura entra ou volta com holo counter.
5. Aphrodias passa a ameaçar dano arcano.
6. O oponente precisa calcular vida, cartas na mão e prevenção arcana.
...
<div class="tcg-card-grid" aria-label="Auras e peças de dano arcano de Zyggy">
  {% include tcg-card.html game="fab" name="Corrosive Space Dust" pitch="red" %}
  {% include tcg-card.html game="fab" name="Stardust Spike" pitch="red" %}
  {% include tcg-card.html game="fab" name="Auric Shards" pitch="red" %}
  {% include tcg-card.html game="fab" name="Cosmic Duality" pitch="red" %}
</div>
...
1. **Sobreviver ao começo do jogo** contra aggro.
2. **Criar pressão inevitável** contra midrange.
3. **Ter plano real contra fadiga e prevenção arcana.**
...
<div class="tcg-card-grid" aria-label="Cartas antigas de Illusionist para testar em Zyggy no Classic Constructed">
  {% include tcg-card.html game="fab" name="Miraging Metamorph" pitch="red" %}
  {% include tcg-card.html game="fab" name="Pierce Reality" pitch="red" %}
  {% include tcg-card.html game="fab" name="Passing Mirage" pitch="red" %}
  {% include tcg-card.html game="fab" name="Haze Bending" pitch="blue" %}
</div>
...
<div class="tcg-card-grid" aria-label="Cartas antigas e equipamentos para Zyggy no Classic Constructed">
  {% include tcg-card.html game="fab" name="Lightning Press" pitch="red" %}
  {% include tcg-card.html game="fab" name="Reality Refractor" %}
  {% include tcg-card.html game="fab" name="Nullrune Gloves" %}
  {% include tcg-card.html game="fab" name="Nullrune Hood" %}
</div>
...
- [Armory Deck: Zyggy — página oficial](https://fabtcg.com/products/product/armory-deck-zyggy/)
- [Armory Deck Battle: Zyggy vs Ira, Scarlet Revenger](https://www.youtube.com/watch?v=ZqARhcFCBIc)
- [Zyggy Armory Deck — Upgrades and Gameplay](https://www.youtube.com/watch?v=MENpztWArmU)
- [Zyggy Starlight Deck Guide: Refractor Might Be Busted](https://www.youtube.com/watch?v=GT1mohBEv6Q)
- [Zyggy vs Boltyn — gameplay de comunidade](https://www.youtube.com/watch?v=a4wAZh99I-0)
...
1. manter a proporção certa de auras e ataques;
2. criar Lightning Flow sem travar;
3. causar dano suficiente antes de perder para aggro ou fadiga.
...
- [Página oficial de Omens of the Third Age](https://fabtcg.com/products/booster-set/omen/)
- [Armory Deck: Zyggy — página oficial](https://fabtcg.com/products/product/armory-deck-zyggy/)
- [Release Notes: Omens of the Third Age](https://fabtcg.com/rules-and-policy-center/release-notes/omens-of-the-third-age/)
...
- [Formato Classic Constructed — regras oficiais](https://fabtcg.com/gameplay-formats/classic-constructed/)
- [Card Legality Policy — Flesh and Blood](https://fabtcg.com/rules-and-policy-center/card-legality-policy/)
- [Formato Silver Age — regras oficiais](https://fabtcg.com/gameplay-formats/silver-age/)
